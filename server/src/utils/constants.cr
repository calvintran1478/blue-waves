...
module Utils::Constants
  ...
  EXPECTED_AUTH_HEADER_SIZE = 97 # 7 + ACCESS_TOKEN_SIZE
  BLACK_LIST_TOKEN_ID_STRING_LENGTH = 121 # 11 + ACCESS_TOKEN_SIZE + 1 + String::HEADER_SIZE
  ...
  ADD_MUSIC_REQUEST_BUFFER_SIZE = 251 # MAX_TITLE_LENGTH + MAX_ARTIST_LENGTH + 1
  UPDATE_MUSIC_REQUEST_BUFFER_SIZE = 251 # MAX_TITLE_LENGTH + MAX_ARTIST_LENGTH + 1
  ...
  ADD_PLAYLIST_REQUEST_BUFFER_SIZE = 81 # MAX_PLAYLIST_NAME_LENGTH + 1
  ADD_PLAYLIST_MUSIC_REQUEST_BUFFER_SIZE = 23 # MUSIC_ID_LENGTH + 1
  UPDATE_PLAYLIST_REQUEST_BUFFER_SIZE = 81 # MAX_PLAYLIST_NAME_LENGTH + 1
